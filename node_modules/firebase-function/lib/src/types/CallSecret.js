...
(function (CallSecret) {
    ...
    function checkCallSecret(callSecret, callSecretKey, logger) {
        const actualHashedData = (0, crypter_1.sha512)(callSecret.expiresAt, callSecretKey);
        ...
        if (UtcDate_1.UtcDate.decode(callSecret.expiresAt).compare(UtcDate_1.UtcDate.now) === 'less')
