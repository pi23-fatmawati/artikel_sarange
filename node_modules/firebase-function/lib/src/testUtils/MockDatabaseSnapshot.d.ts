...
export declare class MockDatabaseSnapshot<DatabaseScheme extends IDatabaseScheme> implements IDatabaseSnapshot<DatabaseScheme> {
    readonly key: string | null;
    private readonly data;
    constructor(key: string | null, data: DatabaseScheme | null);
