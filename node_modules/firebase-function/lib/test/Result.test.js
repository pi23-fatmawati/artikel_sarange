...
describe('Result', () => {
    it('success', () => {
        ...
        (0, chai_1.expect)(src_1.Result.isSuccess(result)).to.be.true;
        (0, chai_1.expect)(src_1.Result.isFailure(result)).to.be.false;
        (0, chai_1.expect)(src_1.Result.success()).to.be.deep.equal({
            state: 'success',
            value: undefined
        });
    });
    it('failure', () => {
        ...
        (0, chai_1.expect)(src_1.Result.isSuccess(result)).to.be.false;
        (0, chai_1.expect)(src_1.Result.isFailure(result)).to.be.true;
    });
});
