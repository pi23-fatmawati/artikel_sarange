...
describe('Parameter builder', () => {
    ...
    it('multiple types', () => {
        const builder = { expectedTypes: ['string', 'number'], build: (value, logger) => value.toString() };
    ...
    describe('value', () => {
        it('undefined', () => {
            const builder = new parameter_1.ValueParameterBuilder('undefined');
        ...
        it('boolean', () => {
            const builder = new parameter_1.ValueParameterBuilder('boolean');
        ...
        it('bigint', () => {
            const builder = new parameter_1.ValueParameterBuilder('bigint');
        ...
        it('symbol', () => {
            const builder = new parameter_1.ValueParameterBuilder('symbol');
        ...
        it('object', () => {
            const builder = new parameter_1.ValueParameterBuilder('object');
        ...
        it('function', () => {
            const builder = new parameter_1.ValueParameterBuilder('function');
    ...
    describe('guard', () => {
        it('undefined', () => {
            const builder = new parameter_1.GuardParameterBuilder('undefined', ((value, logger) => value === undefined));
            (0, chai_1.expect)(builder.expectedTypes).be.be.deep.equal(['undefined']);
            (0, chai_1.expect)(builder.build(undefined, logger.nextIndent)).to.be.undefined;
        });
        it('boolean', () => {
            const builder = new parameter_1.GuardParameterBuilder('boolean', ((value, logger) => value));
            (0, chai_1.expect)(builder.expectedTypes).be.be.deep.equal(['boolean']);
        ...
        it('string', () => {
            const builder = new parameter_1.GuardParameterBuilder('string', ((value, logger) => value === 'a' || value === 'b'));
            (0, chai_1.expect)(builder.expectedTypes).be.be.deep.equal(['string']);
        ...
        it('number', () => {
            const builder = new parameter_1.GuardParameterBuilder('number', ((value, logger) => value === 1 || value === 2));
            (0, chai_1.expect)(builder.expectedTypes).be.be.deep.equal(['number']);
            (0, chai_1.expect)(builder.build(1, logger.nextIndent)).to.be.equal(1);
        ...
        it('bigint', () => {
            const builder = new parameter_1.GuardParameterBuilder('bigint', ((value, logger) => value === 1n || value === 2n));
            (0, chai_1.expect)(builder.expectedTypes).be.be.deep.equal(['bigint']);
        ...
        it('object', () => {
            const builder = new parameter_1.GuardParameterBuilder('object', ((value, logger) => value !== null && 'v' in value && typeof value.v === 'string'));
            (0, chai_1.expect)(builder.expectedTypes).be.be.deep.equal(['object']);
    ...
    describe('build', () => {
        it('undefined', () => {
            const builder = new parameter_1.ParameterBuilder('undefined', (value, logger) => 'asdf');
        ...
        it('boolean', () => {
            const builder = new parameter_1.ParameterBuilder('boolean', (value, logger) => value ? 'a' : 'b');
        ...
        it('string', () => {
            const builder = new parameter_1.ParameterBuilder('string', (value, logger) => value + 'asdf');
        ...
        it('number', () => {
            const builder = new parameter_1.ParameterBuilder('number', (value, logger) => value.toString());
            (0, chai_1.expect)(builder.expectedTypes).to.be.deep.equal(['number']);
            (0, chai_1.expect)(builder.build(0, logger.nextIndent)).to.be.equal('0');
            (0, chai_1.expect)(builder.build(-1.5, logger.nextIndent)).to.be.equal('-1.5');
        });
        it('bigint', () => {
            const builder = new parameter_1.ParameterBuilder('bigint', (value, logger) => value.toString());
        ...
        it('object', () => {
            const builder = new parameter_1.ParameterBuilder('object', (value, logger) => value === null ? null : 'asdf');
    ...
    describe('optional', () => {
        it('undefined', () => {
            const builder = new parameter_1.OptionalParameterBuilder(new parameter_1.ValueParameterBuilder('undefined'));
            (0, chai_1.expect)(builder.expectedTypes).to.be.deep.equal(['undefined']);
            (0, chai_1.expect)(builder.build(undefined, logger.nextIndent)).to.be.undefined;
        });
        it('number', () => {
            const builder = new parameter_1.OptionalParameterBuilder(new parameter_1.ValueParameterBuilder('number'));
            (0, chai_1.expect)(builder.expectedTypes).to.be.deep.equal(['undefined', 'number']);
            (0, chai_1.expect)(builder.build(undefined, logger.nextIndent)).to.be.undefined;
            (0, chai_1.expect)(builder.build(0, logger.nextIndent)).to.be.equal(0);
        });
        it('multiple optional', () => {
            const builder = new parameter_1.OptionalParameterBuilder(new parameter_1.OptionalParameterBuilder(new parameter_1.OptionalParameterBuilder(new parameter_1.ValueParameterBuilder('number'))));
            (0, chai_1.expect)(builder.expectedTypes).to.be.deep.equal(['undefined', 'number']);
            (0, chai_1.expect)(builder.build(undefined, logger.nextIndent)).to.be.undefined;
            (0, chai_1.expect)(builder.build(0, logger.nextIndent)).to.be.equal(0);
        });
    ...
    describe('nullable', () => {
        it('undefined', () => {
            const builder = new parameter_1.NullableParameterBuilder(new parameter_1.ValueParameterBuilder('undefined'));
            (0, chai_1.expect)(builder.expectedTypes).to.be.deep.equal(['object', 'undefined']);
            (0, chai_1.expect)(builder.build(undefined, logger.nextIndent)).to.be.undefined;
            (0, chai_1.expect)(builder.build(null, logger.nextIndent)).to.be.null;
            (0, chai_1.expect)(() => builder.build({ v: 0 }, logger.nextIndent)).to.throw();
        });
        it('number', () => {
            const builder = new parameter_1.NullableParameterBuilder(new parameter_1.ValueParameterBuilder('number'));
            (0, chai_1.expect)(builder.expectedTypes).to.be.deep.equal(['object', 'number']);
            (0, chai_1.expect)(builder.build(1, logger.nextIndent)).to.be.equal(1);
            (0, chai_1.expect)(builder.build(null, logger.nextIndent)).to.be.null;
            (0, chai_1.expect)(() => builder.build({ v: 0 }, logger.nextIndent)).to.throw();
        });
        it('object', () => {
            const builder = new parameter_1.NullableParameterBuilder(new parameter_1.ValueParameterBuilder('object'));
            (0, chai_1.expect)(builder.expectedTypes).to.be.deep.equal(['object']);
            (0, chai_1.expect)(builder.build(null, logger.nextIndent)).to.be.null;
            (0, chai_1.expect)(builder.build({ v: 0 }, logger.nextIndent)).to.be.deep.equal({ v: 0 });
        });
        it('multiple nullable', () => {
            const builder = new parameter_1.NullableParameterBuilder(new parameter_1.NullableParameterBuilder(new parameter_1.NullableParameterBuilder(new parameter_1.ValueParameterBuilder('number'))));
            (0, chai_1.expect)(builder.expectedTypes).to.be.deep.equal(['object', 'number']);
            (0, chai_1.expect)(builder.expectedTypes).to.be.deep.equal(['object', 'number']);
            (0, chai_1.expect)(builder.build(1, logger.nextIndent)).to.be.equal(1);
            (0, chai_1.expect)(builder.build(null, logger.nextIndent)).to.be.null;
    ...
    describe('array', () => {
        it('undefined', () => {
            const builder1 = new parameter_1.ArrayParameterBuilder(new parameter_1.ValueParameterBuilder('undefined'));
            (0, chai_1.expect)(builder1.expectedTypes).to.be.deep.equal(['object']);
            const builder2 = new parameter_1.ArrayParameterBuilder(new parameter_1.ValueParameterBuilder('undefined'), 2);
            (0, chai_1.expect)(builder2.expectedTypes).to.be.deep.equal(['object']);
        ...
        it('number', () => {
            const builder = new parameter_1.ArrayParameterBuilder(new parameter_1.ValueParameterBuilder('number'));
            (0, chai_1.expect)(builder.expectedTypes).to.be.deep.equal(['object']);
            (0, chai_1.expect)(builder.build([], logger.nextIndent)).to.be.deep.equal([]);
            (0, chai_1.expect)(builder.build([0, 1, 2], logger.nextIndent)).to.be.deep.equal([0, 1, 2]);
        });
        it('build', () => {
            const builder = new parameter_1.ArrayParameterBuilder(new parameter_1.ParameterBuilder('number', value => value.toString()));
            (0, chai_1.expect)(builder.expectedTypes).to.be.deep.equal(['object']);
            (0, chai_1.expect)(builder.build([], logger.nextIndent)).to.be.deep.equal([]);
            (0, chai_1.expect)(builder.build([0, 1, 2], logger.nextIndent)).to.be.deep.equal(['0', '1', '2']);
        });
        it('optional', () => {
            const builder = new parameter_1.ArrayParameterBuilder(new parameter_1.OptionalParameterBuilder(new parameter_1.ValueParameterBuilder('string')));
            (0, chai_1.expect)(builder.expectedTypes).to.be.deep.equal(['object']);
            (0, chai_1.expect)(builder.build([], logger.nextIndent)).to.be.deep.equal([]);
